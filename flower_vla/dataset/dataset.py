...
from flower_vla.dataset import obs_transforms, traj_transforms
from flower_vla.dataset.utils import goal_relabeling, task_augmentation
...
from flower_vla.dataset.utils.rlds_utils import *
...
def make_dataset_from_rlds(
    ...
    *,
    ...
    def restructure(traj: dict) -> dict:
        ...
        #if 'language_embedding' in traj:
        #    task['language_embedding'] = RLDSProcessing.process_language_embedding(traj, traj_len)
    ...
    name = name + ":0.1.0" if name == "bc_z" else 'droid' if name in ["eef_droid", "delta_droid"] else 'kit_irl_real_kitchen_lang' if name == 'kit_irl_real_kitchen_lang_delta' else name
