...
def decode_and_resize(
    ...
    for name in image_names:
        ...
        # print(f"Resizing image_{name} to {resize_size[name]}")
        ...
        if name in resize_size:
            # Explicitly convert size to 1-D int32 tensor
            height, width = resize_size[name]
            size = tf.convert_to_tensor([height, width], dtype=tf.int32)
    ...
    for name in depth_names:
        ...
        if name in depth_resize_size:
            # Explicitly convert size to 1-D int32 tensor
            height, width = depth_resize_size[name]
            size = tf.convert_to_tensor([height, width], dtype=tf.int32)
