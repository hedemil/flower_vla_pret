...
python -m accelerate.commands.launch --num_processes 4 --mixed_precision=bf16 \
    ...
    log_dir="${OUTPUT_DIR}" \
    wandb.name=${MODEL}_${SLURM_JOB_ID}_ratio_0.5_heads_12\
    wandb.entity=null \
    wandb.mode=offline \
    # +continue_training=/leonardo_scratch/fast/AIFAC_F02_024/project/output/checkpoints/runs/2026-04-01/04-23-29/checkpoint_270000 \
    # +step=270000
